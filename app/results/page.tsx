...
import { Brain, ArrowLeft, RotateCcw, Share2, Lightbulb, User } from "lucide-react"
...
export default function ResultsPage() {
  ...
  const handleShare = () => {
    // Mock share functionality - in a real app, this would integrate with social platforms
    alert(
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <Card className="shadow-lg h-fit">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">{result.userData.name}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Primary Skill</p>
                  <p className="text-lg font-semibold text-blue-600">{result.userData.primarySkill}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Experience</p>
                  <p className="text-sm text-gray-700 leading-relaxed">{result.userData.experience}</p>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="text-center mt-12 p-6 bg-white rounded-lg shadow-md">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Ready to Level Up Your Skills?</h3>
